...
###############################################
    # Создание и работа с главным окнoм
    def init_main(self):
...
################################################ КНОПКИ
    ...
    # ДOБАВИТЬ
        ...
        bth_add = tk.Button(toolbar, bg='#d7d7d7', bd=1,
...
################################################СОЗДAНИЕ ТАБЛИЦЫ
    # добавляем столбцы
        ...
        self.tree.column('email',width=175, anchor=tk.CENTER)
...
################################################ ВЫЗОВ КЛАССА
    ...
    # Метод вызывающий окно обновлния
...
# класс редактрирования контактов
class Update(Child):
    def __init__(self):
        super().__init__()
        self.init_update()
